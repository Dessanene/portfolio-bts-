# Script pour ajouter les améliorations esthétiques aux pages spécifiques
$targetPages = @(
    "competences.html",
...
foreach ($page in $targetPages) {
    ...
    if (Test-Path $filePath) {
        ...
        # Ajouter la feuille de style enhanced-pages.css si elle n'existe pas déjà
        if ($content -notmatch '<link rel="stylesheet" href="css/enhanced-pages.css">') {
...
Write-Host "Améliorations esthétiques appliquées aux pages spécifiées!"
